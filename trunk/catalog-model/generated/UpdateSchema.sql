...
BEGIN;
ALTER TABLE catalog.importcategory ADD CONSTRAINT fk_importdefinition FOREIGN KEY (importdefinition_id) REFERENCES catalog.source (id) DEFERRABLE INITIALLY DEFERRED;
COMMIT;

BEGIN;
ALTER TABLE catalog.importproperty ADD CONSTRAINT fk_importdefinition FOREIGN KEY (importdefinition_id) REFERENCES catalog.source (id) DEFERRABLE INITIALLY DEFERRED;
COMMIT;
