...
BEGIN;
CREATE TABLE catalog.shop_languages();
COMMIT;

BEGIN;
ALTER TABLE catalog.shop_languages ADD COLUMN languages_id INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.shop_languages ALTER COLUMN languages_id TYPE INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.shop_languages ALTER COLUMN languages_id DROP NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.shop_languages ADD COLUMN shop_id INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.shop_languages ALTER COLUMN shop_id TYPE INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.shop_languages ALTER COLUMN shop_id DROP NOT NULL;
COMMIT;
...
BEGIN;
ALTER TABLE catalog.shop_languages ADD CONSTRAINT fk_language FOREIGN KEY (languages_id) REFERENCES catalog.language (id) DEFERRABLE INITIALLY DEFERRED;
COMMIT;

BEGIN;
ALTER TABLE catalog.shop_languages ADD CONSTRAINT fk_outputchannel FOREIGN KEY (shop_id) REFERENCES catalog.outputchannel (id) DEFERRABLE INITIALLY DEFERRED;
COMMIT;
