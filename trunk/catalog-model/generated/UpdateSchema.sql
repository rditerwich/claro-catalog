...
BEGIN;
ALTER TABLE catalog.source ADD COLUMN weather VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ALTER COLUMN weather TYPE VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ALTER COLUMN weather DROP NOT NULL;
COMMIT;
