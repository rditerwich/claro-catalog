...
BEGIN;
ALTER TABLE catalog.source ADD COLUMN importurlexpression VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ALTER COLUMN importurlexpression TYPE VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ALTER COLUMN importurlexpression DROP NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ADD COLUMN languageexpression VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ALTER COLUMN languageexpression TYPE VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ALTER COLUMN languageexpression DROP NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ADD COLUMN defaultcurrency VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ALTER COLUMN defaultcurrency TYPE VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ALTER COLUMN defaultcurrency DROP NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ADD COLUMN outputchannelexpression VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ALTER COLUMN outputchannelexpression TYPE VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ALTER COLUMN outputchannelexpression DROP NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ADD COLUMN matchproperty_id INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ALTER COLUMN matchproperty_id TYPE INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ALTER COLUMN matchproperty_id DROP NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ADD COLUMN sequencenr INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ALTER COLUMN sequencenr TYPE INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ALTER COLUMN sequencenr DROP NOT NULL;
COMMIT;
...
BEGIN;
ALTER TABLE catalog.source ADD COLUMN headerline BOOLEAN;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ALTER COLUMN headerline TYPE BOOLEAN;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ALTER COLUMN headerline DROP NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ADD COLUMN charset VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ALTER COLUMN charset TYPE VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ALTER COLUMN charset DROP NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ADD COLUMN separatorchars VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ALTER COLUMN separatorchars TYPE VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ALTER COLUMN separatorchars DROP NOT NULL;
COMMIT;
...
BEGIN;
ALTER TABLE catalog.importcategory ADD COLUMN importsource_id INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.importcategory ALTER COLUMN importsource_id TYPE INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.importcategory ALTER COLUMN importsource_id SET NOT NULL;
COMMIT;
...
BEGIN;
ALTER TABLE catalog.importproperty ADD COLUMN importsource_id INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.importproperty ALTER COLUMN importsource_id TYPE INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.importproperty ALTER COLUMN importsource_id SET NOT NULL;
COMMIT;
...
BEGIN;
ALTER TABLE catalog.source ADD CONSTRAINT fk_matchproperty FOREIGN KEY (matchproperty_id) REFERENCES catalog.property (id) DEFERRABLE INITIALLY DEFERRED;
COMMIT;
