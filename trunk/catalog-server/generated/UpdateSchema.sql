...
BEGIN;
ALTER TABLE catalog.media ADD COLUMN name VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.media ALTER COLUMN name TYPE VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.media ALTER COLUMN name DROP NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.media ADD COLUMN id SERIAL;
COMMIT;

BEGIN;
ALTER TABLE catalog.media ALTER COLUMN id TYPE SERIAL;
COMMIT;

BEGIN;
ALTER TABLE catalog.media ALTER COLUMN id SET NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.media ADD COLUMN content_id INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.media ALTER COLUMN content_id TYPE INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.media ALTER COLUMN content_id SET NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.media ADD COLUMN catalog_id INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.media ALTER COLUMN catalog_id TYPE INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.media ALTER COLUMN catalog_id SET NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.media ADD PRIMARY KEY (id);
COMMIT;

BEGIN;
CREATE TABLE catalog.mediacontent();
COMMIT;

BEGIN;
ALTER TABLE catalog.mediacontent ADD COLUMN mimetype VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.mediacontent ALTER COLUMN mimetype TYPE VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.mediacontent ALTER COLUMN mimetype SET NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.mediacontent ADD COLUMN hash VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.mediacontent ALTER COLUMN hash TYPE VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.mediacontent ALTER COLUMN hash SET NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.mediacontent ADD COLUMN data BYTEA;
COMMIT;

BEGIN;
ALTER TABLE catalog.mediacontent ALTER COLUMN data TYPE BYTEA;
COMMIT;

BEGIN;
ALTER TABLE catalog.mediacontent ALTER COLUMN data SET NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.mediacontent ADD COLUMN id SERIAL;
COMMIT;

BEGIN;
ALTER TABLE catalog.mediacontent ALTER COLUMN id TYPE SERIAL;
COMMIT;

BEGIN;
ALTER TABLE catalog.mediacontent ALTER COLUMN id SET NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.mediacontent ADD PRIMARY KEY (id);
COMMIT;

BEGIN;
CREATE TABLE catalog.mediatag();
COMMIT;

BEGIN;
ALTER TABLE catalog.mediatag ADD COLUMN media_id INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.mediatag ALTER COLUMN media_id TYPE INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.mediatag ALTER COLUMN media_id SET NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.mediatag ADD COLUMN tag VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.mediatag ALTER COLUMN tag TYPE VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.mediatag ALTER COLUMN tag SET NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.mediatag ADD COLUMN id SERIAL;
COMMIT;

BEGIN;
ALTER TABLE catalog.mediatag ALTER COLUMN id TYPE SERIAL;
COMMIT;

BEGIN;
ALTER TABLE catalog.mediatag ALTER COLUMN id SET NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.mediatag ADD PRIMARY KEY (id);
COMMIT;
...
BEGIN;
ALTER TABLE catalog.orderhistory ALTER COLUMN order_id SET NOT NULL;
COMMIT;
...
BEGIN;
ALTER TABLE catalog.importrules ADD COLUMN tabularfileformat_id INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.importrules ALTER COLUMN tabularfileformat_id TYPE INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.importrules ALTER COLUMN tabularfileformat_id DROP NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.importrules ADD COLUMN xmlfileformat_id INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.importrules ALTER COLUMN xmlfileformat_id TYPE INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.importrules ALTER COLUMN xmlfileformat_id DROP NOT NULL;
COMMIT;
...
BEGIN;
ALTER TABLE catalog.catalog ADD COLUMN languages VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.catalog ALTER COLUMN languages TYPE VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.catalog ALTER COLUMN languages SET NOT NULL;
COMMIT;
...
BEGIN;
ALTER TABLE catalog.propertygroup ADD COLUMN catalog_id INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.propertygroup ALTER COLUMN catalog_id TYPE INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.propertygroup ALTER COLUMN catalog_id SET NOT NULL;
COMMIT;
...
BEGIN;
ALTER TABLE catalog.propertygroupassignment ADD COLUMN propertygroup_id INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.propertygroupassignment ALTER COLUMN propertygroup_id TYPE INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.propertygroupassignment ALTER COLUMN propertygroup_id SET NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.propertygroupassignment ADD COLUMN category_id INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.propertygroupassignment ALTER COLUMN category_id TYPE INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.propertygroupassignment ALTER COLUMN category_id SET NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.propertygroupassignment ADD COLUMN id SERIAL;
COMMIT;

BEGIN;
ALTER TABLE catalog.propertygroupassignment ALTER COLUMN id TYPE SERIAL;
COMMIT;

BEGIN;
ALTER TABLE catalog.propertygroupassignment ALTER COLUMN id SET NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.propertygroupassignment ADD COLUMN property_id INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.propertygroupassignment ALTER COLUMN property_id TYPE INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.propertygroupassignment ALTER COLUMN property_id SET NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.propertygroupassignment ADD PRIMARY KEY (id);
COMMIT;
...
BEGIN;
ALTER TABLE catalog.stagingarea ADD COLUMN name VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.stagingarea ALTER COLUMN name TYPE VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.stagingarea ALTER COLUMN name SET NOT NULL;
COMMIT;
...
BEGIN;
CREATE TABLE catalog.stagingstatus();
COMMIT;

BEGIN;
ALTER TABLE catalog.stagingstatus ADD COLUMN catalog_id INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.stagingstatus ALTER COLUMN catalog_id TYPE INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.stagingstatus ALTER COLUMN catalog_id SET NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.stagingstatus ADD COLUMN stagingarea_id INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.stagingstatus ALTER COLUMN stagingarea_id TYPE INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.stagingstatus ALTER COLUMN stagingarea_id SET NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.stagingstatus ADD COLUMN updatesequencenr INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.stagingstatus ALTER COLUMN updatesequencenr TYPE INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.stagingstatus ALTER COLUMN updatesequencenr SET NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.stagingstatus ADD COLUMN id SERIAL;
COMMIT;

BEGIN;
ALTER TABLE catalog.stagingstatus ALTER COLUMN id TYPE SERIAL;
COMMIT;

BEGIN;
ALTER TABLE catalog.stagingstatus ALTER COLUMN id SET NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.stagingstatus ADD PRIMARY KEY (id);
COMMIT;
...
BEGIN;
ALTER TABLE catalog.propertyvalue ADD COLUMN mediavalue_id INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.propertyvalue ALTER COLUMN mediavalue_id TYPE INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.propertyvalue ALTER COLUMN mediavalue_id DROP NOT NULL;
COMMIT;
...
BEGIN;
ALTER TABLE catalog.propertyvalue ADD COLUMN source_id INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.propertyvalue ALTER COLUMN source_id TYPE INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.propertyvalue ALTER COLUMN source_id DROP NOT NULL;
COMMIT;
...
BEGIN;
ALTER TABLE catalog.source ADD COLUMN type VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ALTER COLUMN type TYPE VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ALTER COLUMN type SET NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ADD COLUMN priority INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ALTER COLUMN priority TYPE INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ALTER COLUMN priority DROP NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ADD COLUMN id SERIAL;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ALTER COLUMN id TYPE SERIAL;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ALTER COLUMN id SET NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ADD COLUMN name VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ALTER COLUMN name TYPE VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ALTER COLUMN name DROP NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ADD COLUMN importurl VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ALTER COLUMN importurl TYPE VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ALTER COLUMN importurl DROP NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ADD COLUMN sequentialurl BOOLEAN;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ALTER COLUMN sequentialurl TYPE BOOLEAN;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ALTER COLUMN sequentialurl DROP NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ADD COLUMN orderedurl BOOLEAN;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ALTER COLUMN orderedurl TYPE BOOLEAN;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ALTER COLUMN orderedurl DROP NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ADD COLUMN incremental BOOLEAN;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ALTER COLUMN incremental TYPE BOOLEAN;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ALTER COLUMN incremental DROP NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ADD COLUMN lastimportedurl VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ALTER COLUMN lastimportedurl TYPE VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ALTER COLUMN lastimportedurl DROP NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ADD COLUMN multifileimport BOOLEAN;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ALTER COLUMN multifileimport TYPE BOOLEAN;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ALTER COLUMN multifileimport DROP NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ADD COLUMN job_id INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ALTER COLUMN job_id TYPE INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ALTER COLUMN job_id DROP NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.source ADD PRIMARY KEY (id);
COMMIT;
...
BEGIN;
ALTER TABLE catalog.outputchannel ADD COLUMN languages VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.outputchannel ALTER COLUMN languages TYPE VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.outputchannel ALTER COLUMN languages DROP NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.outputchannel ADD COLUMN shippingcosts FLOAT;
COMMIT;

BEGIN;
ALTER TABLE catalog.outputchannel ALTER COLUMN shippingcosts TYPE FLOAT;
COMMIT;

BEGIN;
ALTER TABLE catalog.outputchannel ALTER COLUMN shippingcosts DROP NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.outputchannel ADD COLUMN expressdeliverycharge FLOAT;
COMMIT;

BEGIN;
ALTER TABLE catalog.outputchannel ALTER COLUMN expressdeliverycharge TYPE FLOAT;
COMMIT;

BEGIN;
ALTER TABLE catalog.outputchannel ALTER COLUMN expressdeliverycharge DROP NOT NULL;
COMMIT;
...
BEGIN;
ALTER TABLE catalog.frequency ADD COLUMN id VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.frequency ALTER COLUMN id TYPE VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.frequency ALTER COLUMN id SET NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.frequency ADD PRIMARY KEY (id);
COMMIT;
...
BEGIN;
ALTER TABLE catalog.job ADD COLUMN name VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.job ALTER COLUMN name TYPE VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.job ALTER COLUMN name SET NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.job ADD COLUMN firstrun TIMESTAMP;
COMMIT;

BEGIN;
ALTER TABLE catalog.job ALTER COLUMN firstrun TYPE TIMESTAMP;
COMMIT;

BEGIN;
ALTER TABLE catalog.job ALTER COLUMN firstrun DROP NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.job ADD COLUMN runfrequency_id VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.job ALTER COLUMN runfrequency_id TYPE VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.job ALTER COLUMN runfrequency_id SET NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.job ADD COLUMN healthperc INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.job ALTER COLUMN healthperc TYPE INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.job ALTER COLUMN healthperc DROP NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.job ADD COLUMN lastsuccess BOOLEAN;
COMMIT;

BEGIN;
ALTER TABLE catalog.job ALTER COLUMN lastsuccess TYPE BOOLEAN;
COMMIT;

BEGIN;
ALTER TABLE catalog.job ALTER COLUMN lastsuccess DROP NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.job ADD COLUMN lasttime TIMESTAMP;
COMMIT;

BEGIN;
ALTER TABLE catalog.job ALTER COLUMN lasttime TYPE TIMESTAMP;
COMMIT;

BEGIN;
ALTER TABLE catalog.job ALTER COLUMN lasttime DROP NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.job ADD COLUMN id SERIAL;
COMMIT;

BEGIN;
ALTER TABLE catalog.job ALTER COLUMN id TYPE SERIAL;
COMMIT;

BEGIN;
ALTER TABLE catalog.job ALTER COLUMN id SET NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.job ADD PRIMARY KEY (id);
COMMIT;
...
BEGIN;
ALTER TABLE catalog.jobresult ADD COLUMN type VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.jobresult ALTER COLUMN type TYPE VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.jobresult ALTER COLUMN type SET NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.jobresult ADD COLUMN job_id INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.jobresult ALTER COLUMN job_id TYPE INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.jobresult ALTER COLUMN job_id SET NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.jobresult ADD COLUMN success BOOLEAN;
COMMIT;

BEGIN;
ALTER TABLE catalog.jobresult ALTER COLUMN success TYPE BOOLEAN;
COMMIT;

BEGIN;
ALTER TABLE catalog.jobresult ALTER COLUMN success SET NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.jobresult ADD COLUMN starttime TIMESTAMP;
COMMIT;

BEGIN;
ALTER TABLE catalog.jobresult ALTER COLUMN starttime TYPE TIMESTAMP;
COMMIT;

BEGIN;
ALTER TABLE catalog.jobresult ALTER COLUMN starttime SET NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.jobresult ADD COLUMN endtime TIMESTAMP;
COMMIT;

BEGIN;
ALTER TABLE catalog.jobresult ALTER COLUMN endtime TYPE TIMESTAMP;
COMMIT;

BEGIN;
ALTER TABLE catalog.jobresult ALTER COLUMN endtime SET NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.jobresult ADD COLUMN log VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.jobresult ALTER COLUMN log TYPE VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.jobresult ALTER COLUMN log SET NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.jobresult ADD COLUMN id SERIAL;
COMMIT;

BEGIN;
ALTER TABLE catalog.jobresult ALTER COLUMN id TYPE SERIAL;
COMMIT;

BEGIN;
ALTER TABLE catalog.jobresult ALTER COLUMN id SET NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.jobresult ADD COLUMN importsource_id INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.jobresult ALTER COLUMN importsource_id TYPE INTEGER;
COMMIT;

BEGIN;
ALTER TABLE catalog.jobresult ALTER COLUMN importsource_id DROP NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.jobresult ADD COLUMN url VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.jobresult ALTER COLUMN url TYPE VARCHAR;
COMMIT;

BEGIN;
ALTER TABLE catalog.jobresult ALTER COLUMN url DROP NOT NULL;
COMMIT;

BEGIN;
ALTER TABLE catalog.jobresult ADD PRIMARY KEY (id);
COMMIT;
...
BEGIN;
ALTER TABLE catalog.media ADD CONSTRAINT fk_content FOREIGN KEY (content_id) REFERENCES catalog.mediacontent (id) DEFERRABLE INITIALLY DEFERRED;
COMMIT;

BEGIN;
ALTER TABLE catalog.media ADD CONSTRAINT fk_catalog FOREIGN KEY (catalog_id) REFERENCES catalog.catalog (id) DEFERRABLE INITIALLY DEFERRED;
COMMIT;

BEGIN;
ALTER TABLE catalog.mediatag ADD CONSTRAINT fk_media FOREIGN KEY (media_id) REFERENCES catalog.media (id) DEFERRABLE INITIALLY DEFERRED;
COMMIT;
...
BEGIN;
ALTER TABLE catalog.stagingstatus ADD CONSTRAINT fk_catalog FOREIGN KEY (catalog_id) REFERENCES catalog.catalog (id) DEFERRABLE INITIALLY DEFERRED;
COMMIT;

BEGIN;
ALTER TABLE catalog.stagingstatus ADD CONSTRAINT fk_stagingarea FOREIGN KEY (stagingarea_id) REFERENCES catalog.stagingarea (id) DEFERRABLE INITIALLY DEFERRED;
COMMIT;
...
BEGIN;
ALTER TABLE catalog.propertyvalue ADD CONSTRAINT fk_mediavalue FOREIGN KEY (mediavalue_id) REFERENCES catalog.mediacontent (id) DEFERRABLE INITIALLY DEFERRED;
COMMIT;
...
-- Update initial content in frequency
BEGIN;
