...
BEGIN;
ALTER TABLE catalog.promotion ADD COLUMN showonmainpage BOOLEAN;
COMMIT;

BEGIN;
ALTER TABLE catalog.promotion ALTER COLUMN showonmainpage TYPE BOOLEAN;
COMMIT;

BEGIN;
ALTER TABLE catalog.promotion ALTER COLUMN showonmainpage SET NOT NULL;
COMMIT;
