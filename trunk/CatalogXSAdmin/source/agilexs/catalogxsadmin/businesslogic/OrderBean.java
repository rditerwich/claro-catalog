...
import agilexs.catalogxsadmin.jpa.order.Order;
import agilexs.catalogxsadmin.jpa.order.ProductOrder;

@Stateless
public class OrderBean extends OrderBeanBase implements agilexs.catalogxsadmin.businesslogic.Order {
	  @EJB
