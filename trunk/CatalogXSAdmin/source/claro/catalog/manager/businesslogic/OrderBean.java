...
import claro.catalog.manager.businesslogic.OrderBeanBase;
import claro.jpa.order.Order;
import claro.jpa.order.ProductOrder;

@Stateless
public class OrderBean extends OrderBeanBase implements claro.catalog.manager.businesslogic.Order {
	  @EJB
