...
public class Table extends Grid {
  ...
  public class HeaderRowFormatter extends RowFormatter {
    ...
    public com.google.gwt.user.client.Element getElement(int row) {
      ...
      return getRow((com.google.gwt.user.client.Element) Element.as(theadElement), row);
    }
    ...
    @Override
    protected com.google.gwt.user.client.Element getRow(com.google.gwt.user.client.Element elem, int row) {
  ...
  public void removeHeaderRow(int row) {
    ...
    theadElement.removeChild(headerRowFormatter.getRow((com.google.gwt.user.client.Element) Element.as(theadElement), row));
    numHeaderRows--;
  }
  ...
  public void resizeHeaderRows(int rows) {
    ...
    if (rows < 0) {
      throw new IndexOutOfBoundsException("Cannot set number of header rows to "
          + rows);
    }
    if (numHeaderRows < rows) {
   ...
   *
   * @param row header row index to check
   * @throws IndexOutOfBoundsException
   */
  ...
  protected void insertHeaderCell(int row, int column) {
    DOM.insertChild(headerRowFormatter.getRow(
        (com.google.gwt.user.client.Element) Element.as(theadElement), row), createHeaderCell(),
        column);
  }
  ...
  protected void prepareHeaderCell(int row, int column) {
    ...
    if (column < 0) {
      throw new IndexOutOfBoundsException(
          "Cannot access a header column with a negative index: " + column);
    }
   ...
   *
   * @param row The header row index to be checked
   * @throws IndexOutOfBoundsException if the header row is negative
   */
  ...
  protected void removeHeaderCell(int row, int column) {
    ...
    final Element tr = headerRowFormatter.getRow((com.google.gwt.user.client.Element) Element.as(theadElement), row);
   ...
   */
  private com.google.gwt.user.client.Element cleanHeaderCell(int row, int column, boolean clearInnerHTML) {
    // Clear whatever is in the cell.
    final com.google.gwt.user.client.Element th = (com.google.gwt.user.client.Element)
        Element.as(getHeaderCellElement(theadElement, row, column));
  ...
  private TableCellElement getHeaderCellElement(TableSectionElement head, int row, int col) {
