...
public class GetShopsImpl extends GetShops implements CommandImpl<GetShops.Result>{
	...
	static View view = new BasicView("catalog", "navigation", "navigation/subNavigation", "navigation/category", "promotions", "promotions/shop", "promotions/templates", "excludedItems", "excludedProperties");
